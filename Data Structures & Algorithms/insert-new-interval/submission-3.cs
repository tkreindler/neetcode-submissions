public class Solution {
    public int[][] Insert(int[][] intervals, int[] newInterval) {
        ...
        int insertionStart = this.BinarySearch(intervals.Length, i => intervals[i][0], newBegin);
        int insertionEnd = this.BinarySearch(intervals.Length, i => intervals[i][1], newEnd);
    ...
    private int BinarySearch(int length, Func<int, int> lookup, int desiredValue)
    {
        int low = 0;
        int high = length;
